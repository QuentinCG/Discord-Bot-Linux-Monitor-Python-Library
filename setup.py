...
setup(
    ...
    platforms='Linux',
    install_requires=[
        "linuxmonitor~=1.7.3",  # follows the {MAJOR}.{MINOR}.x version range (because LinuxMonitor and DiscordBotLinuxMonitor are tightly coupled and should have same major and minor version)
        "discord.py",
        "typing",
        "asyncio",
    ]
